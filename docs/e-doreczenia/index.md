...
Konto z wyszukaną skrzynką edoręczeń można rozpoznać po ikonie koperty ![Koperta](screeny\PODATKIKS_ikona_koperta.png), która wyświetla się przy koncie oraz przy współwłaścicielu na liście współwłasności.

![Wspolwlasnosci](screeny/kp_wspolwlasnosci.png) 


Dodatkowo w dolnej części panelu współwłasności oraz na koncie indywidualnym wyświetla się pole z adresm skrzynki.
